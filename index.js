...
/////////////////
const BotName = 'MrPOKS'; 
const instagram = 'https://instagram.com/poukes_?igshid=1p7c13mnumerj'; 
const telegram = 'COMING SOON'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCzaC2m7v_j8_JOHV0WuC_mw';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@poukes_')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@poukes_`)
})
